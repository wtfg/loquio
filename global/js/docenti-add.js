...
$(document).ready(function() {
    ...
    str += '<br /><label style="font-size:11px" for="' + day + 'Max">Max pren.</label> <input name="' + day + 'Max" type="text" value="' + jgiorno + '" id="' + day + 'Max" size="2" class="input-mini" maxlength="2" />  <br /><br />';
    for (t in timeslot) {
    var time = timeslot[t];
    var checked = "";
    if (js[day] !== undefined) {
...
* */
str += '<label><input class="ace-checkbox-2" s type="checkbox" ' + checked + ' name="' + day + time + '" id="' + day + time + '" /> <span class="lbl">' + time + '</span></label>';
}
str += "</div>"
}
$(container).html(str);
