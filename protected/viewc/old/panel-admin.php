...
<body style="text-align:center;">
    ...
    <br>
    <a href=<?php echo Doo::conf()->APP_URL."prenotazioni/list"?> class="butt">Lista Pren</a>
    <a href=<?php echo Doo::conf()->APP_URL."prenotazioni/new"?> class="butt">Pren Colloquio</a>
