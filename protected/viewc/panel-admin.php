...
<div class="widget-header">
    ...
    <a href=<?php echo Doo::conf()->APP_URL."admin/docenti/"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon fa icon-group bigger-230"></i>
        Docenti
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/prenotazioni/"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-edit-sign bigger-230"></i>
        Prenotazioni mattutine
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/pomeridiani"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-user bigger-230"></i>
        Lista dei pomeridiani
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/materie"?> class="btn btn-app btn-primary btn-app-home">
    ...
    <a href=<?php echo Doo::conf()->APP_URL."prenotazioni/new"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-check bigger-230"></i>
        Prenota mattutini
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/calendars"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-calendar bigger-230"></i>
        Calendari
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/utenti"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-user bigger-230"></i>
        Utenti
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/bookoff"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-eraser bigger-230"></i>
        Bookoff
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/config"?> class="btn btn-app btn-primary btn-app-home">
        <i class="ace-icon icon-cogs bigger-230"></i>
        Configurazione
    </a>
    <a href=<?php echo Doo::conf()->APP_URL."admin/cleardb"?> onclick="return confirm('Questo cancellera tutto il database! Sei sicuro??')" class="btn btn-danger btn-app btn-app-home">
